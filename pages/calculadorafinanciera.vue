<template>
  <section class="cont">
    ...
    <div v-if="!loading" class="container calculadoras">
      ...
      <div class="row ">
        <div class="col-sm-12">
          <h3>DA CLICK EN TU INSTITUCIÓN FINANCIERA DE CONFIANZA</h3>
          <h4>
            <strong>INVIERTE</strong> EL <strong>30%</strong> DE TU
            <strong>SALARIO</strong> EN TU HOGAR
          </h4>
        </div>
      </div>
      <div class="row">
        <div
          v-for="(calculadora, key) in calculadoras"
        ...
        >
          ...
          >
            <div class="logo-banco">
              <img
                :src="
                  `https://strapi.constructorespositivos.com${calculadora.logo.url}`
                "
              />
            </div>
            <span>{{ calculadora.link_title }}</span></a
          >
        </div>
      </div>
    </div>

  ...
  <section class="cont">
    <div class="login pasos">
      ...
      <form ref="form" @submit.stop.prevent="doLogin">
        ...
        <!-- PASSWORD -->
        <validation-provider v-slot="{ errors, valid }" name="Contraseña" rules="required">
          <b-form-group>
            <b-form-input class="element"
                          id="password-input"
        ...
        <div class="smallcontainer">
          <div class="nav-item">
            <nuxt-link to="/authentication/forgot">Olvidaste tu contraseña?</nuxt-link>
          </div>
        </div>
        <div class="smallcontainer">
          <div class="nav-item">
...
//  import { Component, Vue } from 'vue-property-decorator'
  ...
  export default {
    ...
    methods:{
      async doLogin(){
        if (this.email.length==0 || this.password.length==0 || !this.captcha) {

      ...
      <form ref="form" @submit.stop.prevent="doReset">
        <div>
          ...
          <validation-provider  v-slot="{ errors, valid }" name="Contraseña" rules="required">
            <b-form-group>
              <b-form-input class="element" style="width: 100%; margin: 0px;"
                            id="password-input"
        ...
        <div >
          <!-- PASSWORD CONFIRM-->
          <validation-provider v-slot="{ errors, valid }" name="Confirmar Contraseña" rules="required">
            <b-form-group>
              <b-form-input class="element" style="width: 100%; margin: 0px;"
                            id="password2-input"
...
<script >
  ...
  export default {
    ...
    methods:{
      async doReset(){
        if (this.password.length==0 || this.password2.length==0  || !this.captcha) {
